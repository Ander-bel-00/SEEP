...
const NavbarAprendiz = ({ showNav, handleLogout, setShowNav, modalIsOpen }) => {
            ...
            <div className={showNav ? "sidenav active" : "sidenavAprendiz"}>
              ...
              {!modalIsOpen && (
                <ul className="list-group menu-content">
                  <MenuItem title="Inicio" icon={<IoHomeSharp className="inline-block" />} link="/" handleHover={handleHover} handleHoverEnd={handleHoverEnd} />
                  <MenuItem title="Documentos" icon={<IoDocuments className="inline-block mr-1" />} link={`${usuario.id_aprendiz}/documents-aprendiz`} handleHover={handleHover} handleHoverEnd={handleHoverEnd} />
                  <MenuItem title="Bitácoras" icon={<FaFileExcel className="inline-block mr-1" />} link={`${usuario.id_aprendiz}/bitacoras-aprendiz`} handleHover={handleHover} handleHoverEnd={handleHoverEnd} />
                  <MenuItem title="Cerrar Sesión" icon={<BiSolidLogOut className="inline-block mr-1" />} handleHover={handleHover} handleHoverEnd={handleHoverEnd} handleLogout={handleLogout} />
                </ul>
              )}
              {hoveredOption && (
